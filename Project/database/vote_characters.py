...
class VotesCharacters:
   ...
   # Create entries inside the Votes table with the votes made by each Ip address
    ...
    def countCharactersVotes(self,charactername):
        ...
        sql="Select COUNT(*) as votes from votes WHERE charactername like %s"
...
if __name__ == "__main__":
   ...
   #Creating the databse and the vote table. Just need to be run once.
    ...
    #data = ("Stele", "252.552.354.225")
    #votesCharacters.createVote(data)
    count = votesCharacters.countCharactersVotes('Stele')
    print(count)

    print("is that ok?")


    ######Check the SQl Sinthax error